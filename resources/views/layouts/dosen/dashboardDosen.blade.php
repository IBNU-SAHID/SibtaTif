                                    ...
                                    <li>
                                        <a href="/dosen/bimbingan"
                                            ...
                                            <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                                sidebar-toggle-item>Bimbingan</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="flex flex-col">
                    <div class="basis-full ">
                        <section>
                            <div class="flex flex-col ">
                                <nav
                                    class="bg-white  drop-shadow-lg border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-900">
                                    <div class="container flex flex-wrap items-center mx-auto md:place-content-between">
                                        ...
                                        <div id="logo-nav" class="mx-auto md:hidden">
                                            <a href="/"
                                                ...
                                                <img class="w-[52px] h-[52px] "
                                                    src="{{ asset('/img/logo/logo.png') }}" alt="logo">
                                                SibTA
                                            </a>
                                        </div>
