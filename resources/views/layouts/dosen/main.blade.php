        ...
        <div id="sidebar" class="basis-auto  bg-gray-800 max-sm:hidden">
            ...
            <section id="sidebar-buka" class="block">
                <ul>
                        ...
                        <aside class="w-64" aria-label="Sidebar">
                            <div class="overflow-y-auto py-4 px-3 bg-gray-800 rounded dark:bg-gray-800">
                                <ul class="space-y-2">
                                    ...
                                    <li></li>
                                    <p class="text-md text-gray-100 my-2">Halo! <br> {{ Auth::user()->name }}</p>
                    ...
                    <li>
                        <button type="button"
                            class="flex items-center p-2 w-full text-base font-normal text-gray-100 rounded-lg transition duration-75 group hover:bg-gray-600 dark:text-white dark:hover:bg-gray-700"
                            aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                            <img src="{{ asset('/img/icon/mhs.png') }}" />
                            <span class="flex-1 ml-3 text-left whitespace-nowrap " sidebar-toggle-item>Mahasiswa</span>
                        ...
                        <ul id="dropdown-example" class="hidden py-2 space-y-2">
                            <li>
                                <a href="/dosen/bimbingan"
                                    class="flex items-center p-2 pl-11 w-full text-base font-normal text-info-500 rounded-lg transition duration-75 group hover:bg-gray-600  ">Sedang
                                    Bimbingan</a>
                            </li>
                            <li>
                                <a href="/dosen/bimbingan/selesai"
                                    class="flex items-center p-2 pl-11 w-full text-base font-normal text-danger-500 rounded-lg transition duration-75 group hover:bg-gray-600 ">Selesai
                                    Bimbingan</a>
                            </li>
                        </ul>
                    </li>
