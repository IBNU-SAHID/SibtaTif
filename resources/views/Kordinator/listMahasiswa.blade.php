...
@section('title', 'Bimbngan Mahasiswa')
...
@section('content')
    ...
    <div
        ...
        <div class="flex flex-row">
            ...
            <div class="basis-full max-sm:basis-1/2 flex place-content-end">
                ...
                <button
                    class="hidden max-sm:block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    type="button" data-modal-toggle="authentication-modal">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="relative w-full max-w-md h-full md:h-auto">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="py-6 px-6 lg:px-8">
                                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Pendaftaran
                                    mahasiswa <TAble></TAble>
                                </h3>
                                <div class="space-y-5">
                                    <div>
                                        ...
                                        <input type="text" name="link-penaftaran-d" id="link-penaftaran-m"
                                            value="sibta.test/mahasiswa/daftar"
    ...
    {{-- CONTENT 2 --}}
    <div
        class="w-full h-min-[330px]  max-sm:w-screen p-4 max-sm: text-left bg-white border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    ...
    <script>
        function copyToClipboard() {
            document.getElementById("link-penaftaran-m").select();
